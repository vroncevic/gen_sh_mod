#!/bin/bash
#
# @brief   Shell Module Generator
# @version ver.3.0
# @date    Wed 01 Dec 2021 11:40:02 PM CET
...
GEN_SH_MOD_LOGO=${GEN_SH_MOD_HOME}/conf/${GEN_SH_MOD_TOOL}.logo
...
declare -A GEN_SH_MOD_LOGO_DATA=(
    [OWNER]="vroncevic"
    [REPO]="${GEN_SH_MOD_TOOL}"
    [VERSION]="${GEN_SH_MOD_VERSION}"
    [LOGO]="${GEN_SH_MOD_LOGO}"
)
...
function __gen_sh_module {
    ...
    display_logo GEN_SH_MOD_LOGO_DATA
